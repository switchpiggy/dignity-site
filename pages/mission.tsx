    ...
    <>
      ...
      <main className={`${open_sans.variable} font-sans flex flex-col justify-evenly bg-gradient-to-b from-white to-pink-100`}>
        ...
        <div className={`flex text-zinc-900 flex-col w-full pl-10 pr-10`}>
          <h1 className={`text-4xl pl-10 pr-10 pt-10 pb-7 font-medium`}>OUR MISSION</h1>
          <h2 className={`text-2xl pl-10 w-6/12`}>
          The core focus of Dignity is to combat period poverty by ensuring that no woman or girl is held back due to lack of access to menstrual products. We believe in a world where menstruation is not a barrier to education, work, or personal development. Our mission is to promote dignity, health, and equality through comprehensive menstrual health programs.
          </h2>
